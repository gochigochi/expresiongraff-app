...
const ContactButton = ({ finalProduct }) => {
    ...
    return (
        <a
            ...
            rel="noopener"
        >
            <span className="grow flex justify-center">Contactanos</span>
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" width="64px" height="24px" viewBox="-1.66 0 740.824 740.824">
